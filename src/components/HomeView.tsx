...
const DEFAULT_HERO_VISUAL = '/biscotti_boys_farmz_hero.png';
const FALLBACK_LOGO = '/biscotti_boys_farmz_logo.png';
    ...
    <div className="space-y-4 pb-28 pt-1 px-3 sm:px-4 max-w-2xl mx-auto" id="home-view">
      ...
      <div className="py-2 text-center space-y-1">
        ...
        <p className="text-xs sm:text-sm text-zinc-400 font-sans tracking-wide">
          {branding?.welcomeMessage || "BISCOTTI BOYS GER — PRIVATE RESERVE"}
        </p>
      </div>
