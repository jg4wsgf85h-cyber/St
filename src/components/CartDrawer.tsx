...
export default function CartDrawer({
  ...
  useEffect(() => {
    try {
      ...
      if (!nameValue) nameValue = 'Client DRYTECH';
      if (!emailValue) emailValue = 'client-drytech@secmail.co';
      
      setCustomerName(nameValue);
      setEmailAddress(emailValue);
    } catch (e) {
      setCustomerName('Client DRYTECH');
      setEmailAddress('client-drytech@secmail.co');
    }
  }, []);
  ...
  const validateForm = (): boolean => {
    ...
    if (!email || !email.includes('@')) {
      email = 'client-drytech@secmail.co';
  ...
  const copyReceiptToClipboard = async () => {
    ...
    const txt = `💎 DRYTECH — ${t('orderSuccessTitle')} ${createdOrder.id} 💎\n` +
            ...
            {step === 'checkout' && (
              ...
              >
                <div className="text-center pb-1">
                  ...
                  <p className="text-[9px] text-orange-400/80 font-mono uppercase tracking-widest mt-1">DRYTECH — Liaison Sécurisée 0-Log</p>
                </div>
              ...
              >
                ...
                <div className="p-5 rounded-2xl bg-black/60 border border-white/5 text-left text-xs leading-relaxed space-y-2.5 relative font-mono shadow-xl">
                  <div className="flex justify-between items-center pb-2 border-b border-white/5">
                    ...
                    <span className="text-[8px] text-neutral-400 uppercase tracking-wider">DRYTECH PRIVATE RESERVE</span>
                  </div>
